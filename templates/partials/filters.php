...
<div class="ll-ba-filters" id="ll-ba-filters">
  ...
  <div class="hidden ll-ba-filters__active" id="ll-ba-active-bar">
    <div class="flex flex-wrap gap-2 items-center py-3 border-b border-gray-200">
      ...
      <div class="flex flex-wrap gap-2" id="ll-ba-active-tags"></div>
      <button
        type="button"
        id="ll-ba-clear-all"
  ...
  ?>
    <div
      ...
      data-meta-key="<?php echo esc_attr($taxonomy); ?>"
    ...
    >
      ...
      >
        ...
        <svg class="w-4 h-4 transition-transform duration-200 ll-ba-filter-arrow shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
      ...
      <div class="hidden pb-4 ll-ba-filter-content">
        ...
        <?php if ($display === 'dropdown') : ?>
          <select class="px-3 py-2 w-full text-sm rounded border border-gray-300 ll-ba-dropdown-filter focus:outline-none focus:ring-1 focus:ring-current">
            <option value=""><?php printf(esc_html__('All %s', 'll-bag'), esc_html($filter['label'])); ?></option>
          ...
          <?php if (!empty($filter['searchable'])) : ?>
            <div class="relative mb-3">
              <input
                ...
                placeholder="<?php printf(esc_attr__('Search %s', 'll-bag'), esc_attr($filter['label'])); ?>"
              >
